...
<div class="container mt-5">
    <div class="card" style="width: 50rem;">
        ...
        <div class="container d-flex" style="justify-content:center; align-items:center;">
            <a href="/updatemasuk/{{ $data->id }}" class="btn btn-warning " tooltip="" style="color: white;"
                data-original-title="" title="">Edit</a>
            <form method="post">
                <a onclick="checker()" type="button" href="/deletemasuk/{{ $data->id }}" rel="tooltip"
                    class="btn btn-danger ml-3" style="color: white;" data-original-title="" title="">
                  Hapus
                </a>
            </form>
            {{-- <button type="submit" class="bg-success btn ml-3"><a class="text-white "
                        href="{{ asset('assets/file') }}/{{ $data->file }}" download>Download</a></button> --}}
        </div>
        <a href="/suratmasuk" class="bg-secondary btn ml-3">Kembali</a>
    </div>
    </center>
</div>
</div>
